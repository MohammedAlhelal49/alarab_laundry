...
registry.category("web_tour.tours").add('payroll_tours', {
    ...
    steps: () => [
    {
        trigger: `.o_app[data-menu-xmlid='hr_work_entry_contract_community.menu_hr_payroll_root']`,
    ...
    {
        trigger: `button[data-menu-xmlid='hr_work_entry_contract_community.menu_hr_payroll_work_entries_root']`,
        content: markup(_t('Click on the <strong>Work Entries</strong> menu.')),
        tooltipPosition: 'bottom',
        run: "click",
    },
    {
        trigger: `a[data-menu-xmlid='hr_work_entry_contract_community.menu_work_entry']`,
