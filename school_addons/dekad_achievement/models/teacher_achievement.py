...
class DeTeacherAchievement(models.Model):
    _name = "de.teacher.achievement"
    _description = "Teachers Achievements"
    ...
    def copy(self, default=None):
        ...
        return super(DeTeacherAchievement, self).copy(default)
