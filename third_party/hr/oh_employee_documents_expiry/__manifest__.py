...
#############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            'oh_employee_documents_expiry/static/src/js/employee_document_dashboard.js',
            'oh_employee_documents_expiry/static/src/xml/employee_document_dashboard.xml',
            'oh_employee_documents_expiry/static/src/scss/employee_document_dashboard.scss',
        ],
    },
